export const aaguids = {
  ...
  'ee882879-721c-4913-9775-3dfcce97072a': { name: 'YubiKey 5 (USB-A, No NFC)' },
  '2fc0579f-8113-47ea-b116-bb5a8db9202a': { name: 'YubiKey 5 NFC' },
  'a25342c0-3cdc-4414-8e46-f4807fca511c': { name: 'YubiKey 5 NFC' },
  '20ac7a17-c814-4833-93fe-539f0d5e3389': { name: 'YubiKey 5 Nano' },
  'c5ef55ff-ad9a-4b9f-b580-adebafe026d0': { name: 'YubiKey 5Ci' },
  'e77e3c64-05e3-428b-8824-0cbeb04b829d': { name: 'Security Key NFC (Black)' },
}
