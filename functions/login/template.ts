...
Hello ${email},
We’ve received a login attempt with the following code: ${displayCode}

To login, please go to the following link: ${callToAction}

Please ignore this email if you didn’t attempt to log in.
`
...
<body
  ...
  <span class="preheader"
    ...
    attempt received on esc.vote CMS.</span>
                  ...
                  <td class="content-cell"
                    ...
                    <div class="f-fallback">
                      ...
                      <p style="margin-top: 0; color: #09090B99; font-size: 14px; font-weight: 400; text-align: left;"
                        ...
                        <br>
                        We've just received a login attempt to 
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                              <tr>
                                <td align="left"
                                  ...
                                  <a href="${url}" class="f-fallback button" target="_blank"
